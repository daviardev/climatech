  ...
  useEffect(() => {
    const filtered = tipos.filter(
      (tipo) =>
        ...
        (tipo.marca &&
          tipo.marca.toLowerCase().includes(searchTerm.toLowerCase())),
    );
  ...
  const handleOpenDialog = (tipo?: Record<string, unknown>) => {
    ...
    if (tipo) {
      ...
      setFormData({
        ...
        marca: (tipo as any).marca || "",
      });
    } else {
      setEditingTipo(null);
      setFormData({ nombre: "", descripcion: "", marca: "" });
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestiona los tipos de equipamiento disponibles
          </p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                {editingTipo ? "Editar Tipo de Equipo" : "Nuevo Tipo de Equipo"}
              </DialogTitle>
              <DialogDescription>
                {editingTipo
              ...
              <FieldGroup>
                ...
                <Field>
                  ...
                  <Input
                    ...
                    disabled={isSaving}
                    placeholder="Ej: Sistemas de aire acondicionado residencial"
                  />
                </Field>
                <Field>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {filteredTipos.length} tipos de equipo
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
              ...
              {filteredTipos.length === 0 ? (
                <TableRow>
                  <TableCell
                    ...
                    Sin tipos de equipo registrados
                  </TableCell>
                </TableRow>
              ) : (
                filteredTipos.map((tipo) => (
                  <TableRow key={tipo.id}>
                    ...
                    <TableCell>{tipo.marca || "-"}</TableCell>
